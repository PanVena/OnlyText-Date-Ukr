function TextNumbers(languageCode, x) {
    let numbers = {
        ...
        uk: {
            1: "Перше", 2: "Друге", 3: "Третє", 4: "Четверте", 5: "П’яте", 6: "Шосте", 7: "Сьоме", 8: "Восьме", 9: "Дев’яте", 10: "Десяте",
            11: "Одинадцяте", 12: "Дванадцяте", 13: "Тринадцяте", 14: "Чотирнадцяте", 15: "П’ятнадцяте", 16: "Шістнадцяте", 17: "Сімнадцяте", 18: "Вісімнадцяте", 19: "Дев’ятнадцяте", 20: "Двадцяте",
            21: "Двадцять перше", 22: "Двадцять друге", 23: "Двадцять третє", 24: "Двадцять четверте", 25: "Двадцять п’яте", 26: "Двадцять шосте", 27: "Двадцять сьоме", 28: "Двадцять восьме", 29: "Двадцять дев’яте", 30: "Тридцяте", 31: "Тридцять перше"
        }
